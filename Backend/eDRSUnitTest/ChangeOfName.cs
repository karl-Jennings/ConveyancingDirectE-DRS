...
using LrApiManager.SOAPManager.ChangeOfName;
...
namespace eDRSUnitTest
{
    ...
    public class ChangeOfNameTest
    {
        ...
        {
            ChangeOfNameApplicationManager changeOfNameApplicationManager = new ChangeOfNameApplicationManager();
            ...
            ChangeOfNameApplicationRequest changeOfNameApplicationRequest = new ChangeOfNameApplicationRequest
            {
