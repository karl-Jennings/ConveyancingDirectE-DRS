...
namespace eDrsDB.Migrations
{
    ...
    [Migration("20210219064250_lessetitle")]
    partial class lessetitle
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 455, DateTimeKind.Local).AddTicks(9544),
                        ...
                        new
                        {
                            ...
                            TypeCode = "lease_ext",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6457),
                            Url = "lease-extension"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6488),
                            Url = "new-lease"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6491),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6493),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6495),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6496),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 2, 19, 12, 12, 49, 457, DateTimeKind.Local).AddTicks(6498),
                            Url = "transfer"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 4, 239, 166, 212, 236, 183, 35, 198, 197, 197, 160, 89, 50, 166, 124, 152, 197, 41, 146, 77, 38, 130, 84, 157, 202, 123, 28, 200, 220, 43, 233, 17, 247, 173, 153, 250, 199, 25, 51, 21, 47, 116, 77, 12, 198, 139, 137, 30, 43, 186, 141, 203, 230, 120, 159, 79, 213, 44, 10, 108, 235, 56, 164, 126 },
                            PasswordSalt = new byte[] { 202, 79, 117, 56, 25, 137, 156, 70, 147, 77, 31, 171, 217, 189, 219, 70, 204, 156, 104, 61, 190, 218, 25, 41, 7, 98, 173, 99, 26, 154, 84, 200, 211, 106, 191, 114, 143, 240, 112, 162, 154, 50, 167, 25, 29, 25, 145, 141, 251, 202, 243, 228, 43, 206, 246, 255, 185, 156, 108, 74, 40, 12, 205, 55, 149, 239, 189, 166, 152, 75, 216, 41, 239, 233, 217, 51, 49, 58, 152, 221, 27, 49, 239, 65, 139, 231, 122, 145, 200, 209, 44, 46, 56, 22, 193, 10, 255, 178, 205, 211, 170, 38, 152, 212, 99, 105, 131, 236, 100, 146, 33, 247, 225, 217, 177, 229, 224, 154, 240, 237, 208, 237, 45, 67, 6, 29, 95, 25 },
                            Status = true,
