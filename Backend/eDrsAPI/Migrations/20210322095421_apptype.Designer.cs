...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20210322095421_apptype")]
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 634, DateTimeKind.Local).AddTicks(7595),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5338),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5361),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5363),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5364),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5366),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5368),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 15, 24, 20, 635, DateTimeKind.Local).AddTicks(5369),
                            Url = "lease-extension"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 231, 222, 183, 20, 254, 199, 222, 97, 101, 7, 19, 144, 55, 30, 134, 240, 190, 228, 143, 215, 225, 15, 156, 198, 235, 158, 132, 70, 5, 104, 74, 104, 129, 21, 54, 202, 67, 90, 138, 45, 155, 150, 119, 6, 9, 243, 4, 78, 209, 3, 205, 78, 4, 133, 96, 53, 125, 136, 70, 78, 208, 235, 218, 194 },
                            PasswordSalt = new byte[] { 104, 4, 184, 73, 166, 100, 155, 95, 230, 234, 92, 106, 227, 96, 68, 97, 176, 33, 104, 83, 170, 198, 239, 231, 9, 215, 170, 144, 242, 218, 60, 121, 187, 104, 28, 12, 113, 94, 183, 25, 56, 23, 225, 217, 3, 14, 163, 197, 197, 122, 216, 26, 39, 98, 203, 51, 201, 136, 155, 205, 98, 138, 202, 71, 151, 132, 52, 38, 164, 218, 182, 124, 83, 31, 168, 251, 185, 110, 103, 127, 197, 247, 26, 74, 87, 93, 43, 30, 226, 25, 224, 68, 46, 117, 130, 127, 201, 137, 154, 130, 59, 236, 92, 164, 37, 246, 105, 229, 70, 248, 77, 10, 121, 104, 29, 111, 120, 187, 118, 230, 232, 120, 105, 68, 211, 12, 73, 38 },
                            Status = true,
