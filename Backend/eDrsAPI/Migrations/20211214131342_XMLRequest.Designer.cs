...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20211214131342_XMLRequest")]
    partial class XMLRequest
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 391, DateTimeKind.Local).AddTicks(4866),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6038),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6072),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6076),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6077),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6079),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6081),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 14, 18, 43, 41, 392, DateTimeKind.Local).AddTicks(6083),
                            Url = "lease-extension"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 48, 28, 254, 14, 129, 95, 67, 180, 97, 153, 41, 255, 144, 62, 39, 139, 61, 147, 234, 132, 103, 184, 106, 101, 155, 37, 1, 209, 212, 106, 158, 16, 243, 193, 62, 94, 231, 42, 86, 50, 92, 147, 153, 44, 155, 82, 125, 67, 36, 226, 222, 57, 206, 26, 97, 80, 235, 39, 90, 211, 125, 15, 199, 93 },
                            PasswordSalt = new byte[] { 31, 80, 162, 35, 18, 74, 111, 20, 44, 38, 162, 160, 100, 8, 67, 162, 22, 193, 138, 13, 241, 216, 99, 49, 132, 243, 135, 236, 215, 179, 113, 44, 20, 71, 161, 216, 215, 102, 84, 28, 6, 104, 101, 254, 74, 188, 23, 177, 117, 147, 129, 154, 95, 234, 160, 144, 16, 81, 185, 180, 20, 251, 218, 206, 37, 122, 98, 42, 224, 190, 128, 123, 164, 189, 101, 199, 240, 167, 204, 107, 181, 116, 229, 168, 248, 217, 95, 124, 19, 54, 155, 2, 49, 102, 209, 192, 111, 248, 111, 244, 170, 48, 148, 156, 173, 181, 84, 254, 242, 119, 230, 82, 231, 171, 124, 133, 59, 40, 52, 237, 100, 183, 52, 72, 253, 40, 178, 18 },
                            Status = true,
