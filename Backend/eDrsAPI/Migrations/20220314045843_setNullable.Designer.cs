...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20220314045843_setNullable")]
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 667, DateTimeKind.Local).AddTicks(2390),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4279),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4320),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4323),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4325),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4328),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4331),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 3, 14, 10, 28, 42, 668, DateTimeKind.Local).AddTicks(4333),
                            Url = "lease-extension"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 232, 102, 195, 157, 221, 209, 35, 50, 42, 167, 83, 2, 7, 43, 140, 160, 23, 79, 236, 168, 185, 67, 184, 228, 146, 91, 240, 213, 203, 117, 92, 122, 152, 240, 172, 70, 252, 100, 152, 240, 240, 2, 36, 62, 120, 41, 101, 189, 110, 57, 88, 132, 245, 232, 216, 203, 146, 65, 206, 241, 153, 162, 234, 107 },
                            PasswordSalt = new byte[] { 199, 98, 93, 92, 101, 246, 40, 87, 199, 88, 121, 191, 76, 188, 152, 123, 237, 62, 165, 200, 58, 204, 163, 137, 180, 182, 0, 235, 9, 46, 148, 229, 169, 224, 246, 108, 224, 100, 75, 107, 102, 177, 103, 200, 172, 23, 2, 78, 135, 108, 76, 146, 65, 237, 77, 20, 26, 253, 199, 205, 40, 115, 144, 197, 69, 70, 204, 57, 77, 56, 128, 101, 246, 234, 32, 179, 127, 244, 34, 144, 111, 71, 79, 146, 0, 222, 150, 118, 13, 67, 81, 108, 35, 18, 66, 231, 250, 208, 219, 191, 119, 29, 156, 48, 131, 46, 99, 228, 78, 60, 248, 48, 172, 72, 143, 57, 21, 65, 165, 249, 226, 204, 91, 54, 21, 18, 43, 21 },
                            Status = true,
