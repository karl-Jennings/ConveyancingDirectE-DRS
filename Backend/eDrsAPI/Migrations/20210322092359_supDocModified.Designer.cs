...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20210322092359_supDocModified")]
    partial class supDocModified
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 31, DateTimeKind.Local).AddTicks(5069),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4836),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4866),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4869),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4871),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4873),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4875),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 22, 14, 53, 58, 32, DateTimeKind.Local).AddTicks(4876),
                            Url = "lease-extension"
                        });
                });
