...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20220419135725_ApplicationFormTable")]
    partial class ApplicationFormTable
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 884, DateTimeKind.Local).AddTicks(4853),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7390),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7434),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7438),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7441),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7443),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7445),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 19, 19, 27, 24, 885, DateTimeKind.Local).AddTicks(7448),
                            Url = "lease-extension"
                        });
                });
