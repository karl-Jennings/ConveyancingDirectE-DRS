...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20211209071320_newcolumns")]
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 276, DateTimeKind.Local).AddTicks(5893),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4777),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4804),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4806),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4808),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4810),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4811),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 12, 9, 12, 43, 20, 277, DateTimeKind.Local).AddTicks(4813),
                            Url = "lease-extension"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 66, 34, 150, 20, 189, 148, 234, 166, 50, 187, 237, 186, 238, 66, 157, 101, 120, 221, 46, 89, 124, 157, 184, 115, 192, 56, 139, 143, 129, 71, 164, 132, 184, 73, 203, 111, 46, 103, 95, 199, 177, 77, 130, 173, 86, 5, 76, 52, 200, 117, 236, 220, 27, 72, 167, 33, 188, 177, 220, 115, 44, 167, 87, 180 },
                            PasswordSalt = new byte[] { 248, 113, 209, 61, 23, 23, 171, 169, 251, 189, 79, 120, 210, 133, 6, 85, 121, 180, 36, 52, 178, 128, 232, 75, 94, 41, 199, 9, 134, 141, 189, 146, 169, 106, 73, 167, 85, 78, 120, 26, 146, 179, 86, 214, 47, 103, 158, 113, 160, 14, 205, 201, 224, 153, 162, 197, 10, 4, 56, 143, 218, 176, 7, 115, 74, 15, 252, 178, 192, 129, 33, 16, 96, 194, 9, 71, 36, 82, 204, 195, 194, 37, 33, 104, 156, 161, 166, 109, 220, 19, 107, 131, 39, 122, 25, 70, 178, 187, 61, 147, 41, 40, 170, 92, 114, 43, 171, 246, 104, 215, 17, 105, 139, 91, 230, 50, 15, 109, 238, 62, 135, 8, 200, 221, 31, 69, 165, 207 },
                            Status = true,
