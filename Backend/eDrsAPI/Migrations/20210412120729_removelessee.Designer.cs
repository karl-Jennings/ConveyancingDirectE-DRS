...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20210412120729_removelessee")]
    partial class removelessee
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 931, DateTimeKind.Local).AddTicks(5140),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3513),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3535),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3537),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3539),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3540),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3541),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 4, 12, 17, 37, 28, 932, DateTimeKind.Local).AddTicks(3543),
                            Url = "lease-extension"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 127, 113, 55, 52, 241, 54, 91, 166, 79, 177, 39, 65, 30, 95, 222, 12, 135, 13, 146, 253, 141, 142, 37, 110, 243, 160, 160, 217, 132, 225, 215, 194, 117, 225, 228, 150, 34, 53, 15, 149, 67, 82, 253, 98, 126, 5, 157, 170, 33, 154, 71, 228, 215, 36, 80, 28, 174, 97, 245, 62, 58, 160, 185, 105 },
