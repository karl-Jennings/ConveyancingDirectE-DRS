...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20220403055516_AttachementResult")]
    partial class AttachementResult
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eDrsDB.Models.AttachmentResult", b =>
                {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 658, DateTimeKind.Local).AddTicks(7773),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6375),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6406),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6472),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6474),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6475),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6477),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2022, 4, 3, 11, 25, 15, 659, DateTimeKind.Local).AddTicks(6478),
                            Url = "lease-extension"
                        });
                });
            ...
            modelBuilder.Entity("eDrsDB.Models.RequestLog", b =>
                {
                    ...
                    b.Property<long?>("AttachmentResultRequestLogId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AttachmentResultRequestLogId");
            ...
            modelBuilder.Entity("eDrsDB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Firstname = "Admin",
                            PasswordHash = new byte[] { 103, 188, 145, 163, 36, 131, 177, 248, 77, 236, 237, 33, 100, 77, 197, 78, 124, 21, 30, 134, 236, 230, 106, 45, 5, 120, 165, 22, 228, 62, 3, 115, 82, 63, 133, 143, 174, 196, 16, 82, 3, 190, 15, 40, 163, 214, 69, 17, 221, 69, 48, 51, 17, 8, 214, 168, 109, 244, 219, 104, 91, 122, 217, 47 },
                            PasswordSalt = new byte[] { 201, 2, 201, 85, 173, 103, 253, 15, 5, 93, 77, 175, 75, 64, 104, 192, 27, 246, 183, 201, 174, 70, 169, 45, 240, 214, 132, 120, 67, 166, 164, 204, 49, 245, 32, 220, 157, 229, 201, 81, 208, 146, 121, 12, 50, 203, 148, 211, 23, 208, 59, 67, 67, 223, 55, 116, 178, 117, 65, 163, 247, 212, 57, 84, 209, 159, 140, 62, 233, 71, 49, 119, 221, 251, 52, 182, 184, 229, 86, 159, 53, 163, 92, 249, 111, 49, 110, 104, 70, 30, 175, 153, 12, 16, 5, 202, 45, 87, 53, 66, 231, 254, 56, 174, 80, 9, 250, 234, 244, 116, 33, 212, 86, 193, 114, 236, 13, 203, 11, 60, 5, 242, 198, 252, 66, 171, 120, 38 },
                            Status = true,
            ...
            modelBuilder.Entity("eDrsDB.Models.RequestLog", b =>
                {
                    b.HasOne("eDrsDB.Models.AttachmentResult", null)
                        .WithMany("AttachmentResponse")
                        .HasForeignKey("AttachmentResultRequestLogId");
