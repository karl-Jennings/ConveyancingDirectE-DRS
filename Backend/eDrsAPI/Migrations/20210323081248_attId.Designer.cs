...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20210323081248_attId")]
    partial class attId
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 904, DateTimeKind.Local).AddTicks(9106),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7458),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7482),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7484),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7486),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7487),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7488),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 3, 23, 13, 42, 47, 905, DateTimeKind.Local).AddTicks(7490),
                            Url = "lease-extension"
                        });
                });
