...
namespace eDrsAPI.Migrations
{
    ...
    [Migration("20210510060012_overallStatus")]
    partial class overallStatus
    {
            ...
            modelBuilder.Entity("eDrsDB.Models.RegistrationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 737, DateTimeKind.Local).AddTicks(2081),
                        ...
                        new
                        {
                            ...
                            TypeCode = "rem_gage",
                            TypeName = "Remortgage",
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(363),
                            Url = "remortgage"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(387),
                            Url = "transfer-equity"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(390),
                            Url = "removal-form"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(391),
                            Url = "change-name"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(393),
                            Url = "dispositionary"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(394),
                            Url = "transfer"
                        },
                        new
                        {
                            ...
                            UpdatedDate = new DateTime(2021, 5, 10, 11, 30, 11, 738, DateTimeKind.Local).AddTicks(396),
                            Url = "lease-extension"
                        });
                });
