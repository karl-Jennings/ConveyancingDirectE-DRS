...
namespace LrApiManager.SOAPManager.TransferOfEquity
{
    public class TransferOfEquityApplicationManager
    {
        public TransferOfEquityApplicationManager()
        {

        }
        public ApplicationResponse RequestTransferOfEquityApplication(TransfOfEquityApplicationRequest transfOfEquityApplicationRequest)
        {


            XmlDocument doc = SerializeToXml(transfOfEquityApplicationRequest);
            ...
            xmlString = xmlString.Replace("TransfOfEquityApplicationRequest", "eDocumentRegistration");
