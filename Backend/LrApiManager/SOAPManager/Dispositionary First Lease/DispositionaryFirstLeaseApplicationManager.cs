...
namespace LrApiManager.SOAPManager.DispositionaryFirstLease
{
    public class DispositionaryFirstLeaseApplicationManager
    {
        public DispositionaryFirstLeaseApplicationManager()
        {

        }
        public ApplicationResponse RequestChangeOfNameApplication(DispositionaryFirstLeaseApplicationRequest dispositionaryFirstLeaseApplicationRequest)
        {


            XmlDocument doc = SerializeToXml(dispositionaryFirstLeaseApplicationRequest);
            ...
            xmlString = xmlString.Replace("DispositionaryFirstLeaseApplicationRequest", "eDocumentRegistration");
