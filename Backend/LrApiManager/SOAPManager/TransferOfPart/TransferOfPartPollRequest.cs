...
{
    public class TransferOfPartPollRequest
    {
        public TransferOfPartsPollResponse PoolRequest(string MessageID)
        {
            ...
            TransferOfPartsPollResponse _TransferOfPartPoolResponse = GetPoolResponse();

            return _TransferOfPartPoolResponse;
