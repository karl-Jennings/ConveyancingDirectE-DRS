...
namespace LrApiManager.SOAPManager.LeaseExtension
{
    public class LeaseExtensionRequestManager
    {
        public LeaseExtensionRequestManager()
        {

        }
        public ApplicationResponse RequestLeaseExtensionApplication(LeaseExtensionApplicationRequest LeaseExtensionApplicationRequest)
        {


            XmlDocument doc = SerializeToXml(LeaseExtensionApplicationRequest);
            ...
            xmlString = xmlString.Replace("LeaseExtensionApplicationRequest", "eDocumentRegistration");
