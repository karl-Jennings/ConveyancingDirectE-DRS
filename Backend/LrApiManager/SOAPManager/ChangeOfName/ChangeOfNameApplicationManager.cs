...
using LrApiManager.XMLClases.ChangeOfName;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;
using Microsoft.Extensions.FileProviders;

namespace LrApiManager.SOAPManager.ChangeOfName
{
    public class ChangeOfNameApplicationManager
    {
        public ChangeOfNameApplicationManager()
        {

        }
        public ApplicationResponse RequestTransferAndChargeApplication(ChangeOfNameApplicationRequest changeOfNameApplicationRequest)
        {


            XmlDocument doc = SerializeToXml(changeOfNameApplicationRequest);
            ...
            xmlString = xmlString.Replace("ChangeOfNameApplicationRequest", "eDocumentRegistration");
