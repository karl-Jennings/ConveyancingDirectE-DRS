...
namespace LrApiManager.SOAPManager.TranferAndCharge
{
    public class TransferAndChargeApplicationManager
    {
        public TransferAndChargeApplicationManager()
        {

        }
        public ApplicationResponse RequestTransferAndChargeApplication(TransferAndChargeApplicationRequest restrictionApplicationRequest)
        {
            ...
            xmlString = xmlString.Replace("TransferAndChargeApplicationRequest", "eDocumentRegistration");
