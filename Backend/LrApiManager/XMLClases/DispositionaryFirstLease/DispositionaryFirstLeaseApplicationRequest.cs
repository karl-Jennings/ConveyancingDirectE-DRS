...
namespace LrApiManager.XMLClases.DispositionaryFirstLease
{
    public class DispositionaryFirstLeaseApplicationRequest
    {
    ...
    public class Product
    {
        ...
        public List<NewLease> Titles { get; set; }
    ...
    public class Titles
    {
        public NewLease NewLease { get; set; }
    }
    ...
    {
        public LessorTitles DealingTitles { get; set; }
    }
