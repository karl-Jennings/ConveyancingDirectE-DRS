...
namespace LrApiManager.XMLClases.TransferOfPart
{


    public class TransferOfPartApplicationRequest
    {
    ...
    public class Titles
    {
        public Transferofpart TransferOfPart { get; set; }
    }

    public class Transferofpart
    {
        public Transferortitles TransferorTitles { get; set; }
    }

    public class Transferortitles
    {
