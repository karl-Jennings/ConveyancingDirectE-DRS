...
{
    public class LeaseExtensionPollResponse
    {
    ...
    {
        [JsonProperty("RegisterEntry")]
        [JsonConverter(typeof(CustomArrayConverter<Registerentry1>))]
        public IEnumerable<Registerentry1> RegisterEntry { get; set; }
    }
    ...
    {
        [JsonProperty("RegisterEntry")]
        [JsonConverter(typeof(CustomArrayConverter<Registerentry2>))]
        public IEnumerable<Registerentry2> RegisterEntry { get; set; }
    }
